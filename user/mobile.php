...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-danger font-monospace my-3 text-center">MOBILES</h1>
    <?php
  ...
  <div class='card mx-auto' style='width: 18rem;'>
    ...
    <p class='card-text text-danger fs-4 fw-bold'>"; ?> RS: <?php echo number_format($row['PPrice'],2) ?> <?php echo "</p>
      ...
      <form method='post' action='insertcart.php'>
        ...
        <input type='number' name='PQuantity' value='min='1' max='20''  class=' mb-2' placeholder='Quantity' ><br><br>
